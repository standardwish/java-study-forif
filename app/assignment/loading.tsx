import { assignLoadingData } from "@/loadingData/assignmentData";
import Spinner from "../components/loading/Spinner";

export default async function Page() {
  return (
    <>
      <div className="max-w-5xl mb-3 mx-auto mt-10 md:mt-5 md:ml-3 h-screen opacity-10">
        ...
        <div className="w-full relative overflow-x-auto my-14">
          <table className="w-full text-sm text-center">
            ...
            <tbody>
              {assignLoadingData.rowStructured.map((val, idx) => {
                return (
                  <tr key={idx}>
